...
# Replace the ThemeEditorViewController
...
new_class = """class ThemeEditorViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    private func setupUI() {
        ...
        NSLayoutConstraint.activate([
            ...
            previewGrid.widthAnchor.constraint(equalTo: previewContainer.widthAnchor, constant: -32),
            previewGrid.heightAnchor.constraint(equalToConstant: 140),
    ...
    private func updatePreview() {
        ...
        let radius: CGFloat = shape == 0 ? 5 : (shape == 1 ? 20 : 0)
